  ...
  return (
    <main className="relative min-h-[calc(100vh-68px)] overflow-hidden bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="absolute left-[8%] bottom-[20%] h-16 w-16 rounded-2xl border border-blue-200 bg-white/50 rotate-12" />

        <div className="absolute right-[10%] top-[16%] h-24 w-24 rounded-full border border-indigo-200/70 bg-white/40" />
      </div>
        ...
        <div className="grid w-full max-w-5xl items-center gap-10 lg:grid-cols-[0.85fr_1.15fr]">
          ...
          <div className="hidden lg:block">
            ...
            <div className="max-w-md">
              ...
              <h1 className="text-5xl font-bold leading-[1.08] tracking-tight text-gray-950">
                Build your
              ...
              <p className="mt-5 text-base leading-7 text-gray-500">
                Join a community where everyone has
                something valuable to teach and something
                new to learn.
              </p>
              ...
              <div className="mt-8 space-y-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400">
                      Learn through real skill exchanges.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="rounded-[30px] border border-white bg-white/95 p-5 shadow-2xl shadow-blue-900/10 backdrop-blur-xl sm:p-8">
              ...
              <div className="mb-7">
                ...
                <p className="mt-2 text-sm leading-6 text-gray-500">
                  Your next skill exchange starts here.
                </p>
              </div>
